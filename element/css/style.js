#dataTipElement {
    ...
    display: none;
    position: absolute;
    z-index: 2000; /*This is set to 2000 because the file picker is set to 1001*/
    top: 30px;
}
...
.monaco-editor .instructionPointerGlyph {
...
.monaco-editor.vs {
    line-height: 18px;
    font-family: "Consolas"; /*[{plugin-font-editor}]*/
}
...
.monaco-editor.vs .zone-widget .monaco-editor.vs {
    ...
    .monaco-editor.vs .glyph-margin {
        background: TRANSPARENT !important; /*[{plugin-font-editor-margin-background-color} !important]*/
    }
...
.resourcesView {
    background-color: TRANSPARENT; /*[{plugin-resourcesView-background-color}]*/
}
...
.documentPlaceholderRow {
    display: flex;
    white-space: nowrap;
}

.documentPlaceholderKey {
    flex: 1;
    text-align: right;
    padding-right: 14px;
    overflow: hidden;
